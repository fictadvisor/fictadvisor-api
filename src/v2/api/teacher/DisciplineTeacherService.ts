...
export class DisciplineTeacherService {
  ...
  async checkRequiredQuestions (dbQuestions: DbQuestions[], questions: CreateAnswerDTO[]) {
  ...
  async checkExcessiveQuestions (dbQuestions: DbQuestions[], questions: CreateAnswerDTO[]) {
